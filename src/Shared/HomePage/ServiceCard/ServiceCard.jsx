...
const ServiceCard = () => {
    return (
        <div className="my-7">
            ...
            <div className="card md:card-side bg-gray-300 py-4 my-9 shadow-sm px-1.5 md:px-3">
                <figure>
                    <img
                        src={trackingImg}
                        className='w-30 md:w-43'
                        alt="Movie" />
                </figure>
                <div className="divider md:divider-horizontal px-3 md:px-0"></div>
                <div className="card-body w-full md:w-0">
